...
"""
fp_params: dict = {'data_path': '../../datasets/sivaraman/bradberg.csv',
                   'smiles_name': 'smiles',
                   'labels': {'groups': ['X', 'Y', 'YY', 'YYY', 'YYYY', 'YYYYY', 'Z', 'ZZ', 'YZ', 'YYZ', 'YYYZ', '', 'RG', 'AR', 'BR2', 'BR3', 'FU', 'BIP'],
                              'singles': ['\u03A6', '\u03C3', '\u03B5\u00B2\u1d30', '\U0001D45E\u00B3\u1d30', '\U0001D464', '\U0001D45A'],
                          },
                   'fp_type': 'upper',
                   'fp_path': 'upper_bradberg_3d_mass_w.csv',
                   'd_path': 'upper_bradberg_3d_mass_w.pkl',
}

# dataset
data_params: dict = {'fp_path': 'upper_bradberg_3d_mass_w.csv',
                     'target_path': '../../datasets/sivaraman/bradberg/bradberg.csv',
                     'target_name': 'mp',
}
...
save_load_params: dict = {'save_model': False,
                          'load_model': False,
                          'save_model_path': '',
                          'load_model_path': '',
                          'train_fp_path': 'upper_bradberg_3d_mass_w.csv',
